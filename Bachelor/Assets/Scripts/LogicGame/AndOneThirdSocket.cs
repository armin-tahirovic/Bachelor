...
public class AndOneThirdSocket : MonoBehaviour
{
  ...
  {
    if (GameObject.FindGameObjectsWithTag("AndTwoTag")[2].GetComponent<Renderer>().material
      .IsKeywordEnabled("_EMISSION") && GameObject.FindGameObjectsWithTag("OrOneTag")[2].GetComponent<Renderer>()
    ...
    else if (GameObject.FindGameObjectsWithTag("AndTwoTag")[2].GetComponent<Renderer>().material
    ...
    else if (GameObject.FindGameObjectsWithTag("OrOneTag")[2].GetComponent<Renderer>().material
      .IsKeywordEnabled("_EMISSION"))
    {
